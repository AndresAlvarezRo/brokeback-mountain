    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          ...
          <p className={`text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-300 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            Begin your sailing journey with expert instructors, modern vessels, and personalized training programs
          </p>
        </div>

        <div className={`grid md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-12 transition-all duration-1000 delay-500 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <div className="group flex items-center justify-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-all duration-300 transform hover:scale-105 hover:rotate-1">
            ...
            <span className="text-white font-medium">(555) 123-SAIL</span>
          </div>
          <div className="group flex items-center justify-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-all duration-300 transform hover:scale-105 hover:-rotate-1">
            <MapPin className="h-6 w-6 text-blue-300 group-hover:animate-bounce" />
            <span className="text-white font-medium">Marina Bay Harbor</span>
          </div>
        </div>
        ...
        <div className={`mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto transition-all duration-1000 delay-1000 ${
          ...
          <div className="text-center group cursor-default">
            <div className="text-3xl font-bold text-blue-300 group-hover:scale-110 transition-transform duration-300">500+</div>
